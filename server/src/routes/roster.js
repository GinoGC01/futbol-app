...
router.post(
  ...
  [
    ...
    body("color_principal")
      .optional()
      .matches(/^#[0-9A-Fa-f]{6}$/)
      .withMessage("Color en formato #RRGGBB"),
  ],
...
router.get(
  ...
  [
    query("liga_id")
      .isUUID()
      .withMessage("ID de liga requerido para listar equipos"),
  ],
...
router.post(
  ...
  [
    body("nombre")
      .isString()
      .isLength({ min: 2, max: 100 })
      .withMessage("Nombre del jugador inválido"),
    body("apellido")
      .isString()
      .isLength({ min: 2, max: 100 })
      .withMessage("Apellido del jugador inválido"),
...
router.get("/jugadores/recientes", JugadorController.getRecientes);
...
router.post(
  ...
  [
    ...
    body("monto_total")
      .optional()
      .isFloat({ min: 0 })
      .withMessage("Monto total debe ser positivo"),
    body("limite_jugadores")
      .optional()
      .isInt({ min: 5, max: 50 })
      .withMessage("Límite entre 5 y 50"),
  ],
  InscripcionController.inscribirEquipo,
);

router.post(
  "/inscripciones/equipo/batch",
  [
    body("equipo_ids").isArray().withMessage("Se requiere una lista de equipos"),
    body("temporada_id").isUUID().withMessage("ID de temporada requerido"),
    body("limite_jugadores")
      .optional()
      .isInt({ min: 5, max: 50 })
  ...
  InscripcionController.inscribirEquiposBatch,
);
...
router.post(
  ...
  [
    ...
    body("dorsal")
      .optional()
      .isInt({ min: 0, max: 99 })
      .withMessage("Dorsal entre 0 y 99"),
    body("posicion")
      .optional()
...
router.patch(
  ...
  [
    ...
    body("monto_abonado")
      .isFloat({ min: 0 })
      .withMessage("Monto abonado debe ser un número positivo"),
  ],
